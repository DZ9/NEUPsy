...
public class UpdateTeacher extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(nickname == null) {
			...
			String tNickname = new String(request.getParameter("nickname").getBytes("ISO-8859-1"),"utf-8");
System.out.println("UpdateTeacher:"+tNickname);
			...
			teacherDAO.modifyTeacherInfo(tNickname, 
					Integer.parseInt(authority), description, name, email);
			RequestDispatcher view =  
