...
<html>
  <head>
	...
	<script type="application/javascript" src="assert/js/login.js"></script>
  ...
  <body>
    <div style="opacity: 1; position: relative; margin: auto; top: 134.9px;" id="login" class="container">
	    <form method="POST" class="box form-horizontal" action="servlet/Login">
	      <fieldset>
	        <legend style="font-size:18px; font-family:Microsoft YaHei">东北大学心理咨询预约与档案管理系统</legend>
	        
	        <div class="control-group">
	          <span class="control-label">学号</span>
	          <div class="controls">
	            <input name="stuNum" id="stuNum" type="text">
	          </div>
	        </div>
	        <div class="control-group">
	      ...
	      <div class="form-bottom">
	        ...
	        <a href="view/user/register.jsp" class="btn">注册</a>
	      </div>
	    </form>
